...
createDiv('https://upload.wikimedia.org/wikipedia/commons/2/22/Earth_Western_Hemisphere_transparent_background.png', 'Earth Image', 'Earth', 'The third planet from the sun,<br>and the one that humans currently inhabit.<br>It is the only known planet in our solar system to be able to support any form of life!');
...
createDiv('https://t1.gstatic.com/licensed-image?q=tbn:ANd9GcRS5G-fpV8aDvEWIAPzCqEL1jEWMJl5d2YxkLcVUhNlbFJSasq1s4dNjaJpj4Tgldcl', 'Jupiter Image', 'Jupiter', 'The fifth planet from the sun.<br>Jupiter is home to the largest storm in the solar system called the "Great Red Spot"<br>and the earliest observarions of this date back 385 years ago to 1665!<br>The average wind speeds of this srorm are 432 km/h (268 mi/h).<br>It is also the largest planet in our solar system being 2.5x larger than all of the planets in our solar system combined!<br>Jupiter is also the fastest revolving planet with an average day length of 10 Earth Hours.');
...
createDiv('https://t2.gstatic.com/licensed-image?q=tbn:ANd9GcT9RN79wn9Nw-Bt_dn2TjGwLmVo7kxccffCzGa6e1onKI_QyOinDXZ-MMqL_McsRcR1', 'Neptune Image', 'Neptune', 'The eighth and final planet from the sun (in our solar system).<br>It is the coldest planet in the solar system with a temperature of -373 degrees Fahrenheit (-225 Celsius).<br>It is the fourth largest planet with a mass 17x that of Earth and is slightly larger than Uranus.');
